...
CREATE TABLE `program` (
  ...
  UNIQUE KEY `UKcwtbw62tueohji5qrp78dm159` (`uuid`)
...
INSERT INTO `program` VALUES ('EEA - 3','For grade 3 - 5 ','English Ever After - Level 3',60,'2b7cfaff-4b87-4e27-b73b-bab50d0ff3a3',6);
