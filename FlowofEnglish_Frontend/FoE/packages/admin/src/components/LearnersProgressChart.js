...
// const LearnersProgressChart = ({ data, selectedUserId }) => {
//   // Process data based on selected user
//   let learners = [];
//   let learnerNames = [];
//   let subconceptsCompleted = [];

//   if (selectedUserId === 'All users') {
//     // Show data for all users
//     learners = data?.users || [];
//     subconceptsCompleted = learners.map((user) => user.subconceptsCompleted);
//     learnerNames = learners.map((user) => user.userName);
//   } else {
//     // Show data for the selected user
//     const selectedUser = data?.users.find((user) => user.userId === selectedUserId);
//     if (selectedUser) {
//       learners = [selectedUser];
//       subconceptsCompleted = [selectedUser.subconceptsCompleted];
//       learnerNames = [selectedUser.userName];
//     }
//   }
...
//         text: 'Subconcepts Completed',
//       },
//       max: Math.max(...subconceptsCompleted, 10), // Dynamically calculate max value
//     },
//     grid: {
//       xaxis: {
//         lines: {
...
//       <CardContent>
//         <Typography variant="h6" gutterBottom>
//           {selectedUserId === 'All users' ? "Learners' Progress" : `${learnerNames[0]}'s Progress`}
//         </Typography>
//         <div
//           style={{
