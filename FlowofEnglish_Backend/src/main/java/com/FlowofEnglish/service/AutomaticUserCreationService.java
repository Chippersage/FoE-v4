...
//    
//    private static final Logger logger = LoggerFactory.getLogger(AutomaticUserCreationService.class);
//    
//    @Autowired
...
//            logger.info("Skipping user creation for subscription ID: {} as payment status is: {}", 
...
//            Optional<User> existingUser = userRepository.findByUserEmail(subscription.getUserEmail());
//            if (existingUser.isPresent()) {
//                logger.info("User already exists with email: {}", subscription.getUserEmail());
//                
//                // Optionally, you might want to update existing user or enroll them in the new program
...
//        String sanitizedId = userName.replaceAll("\\s+", "").replaceAll("[^a-zA-Z0-9]", "");
//        
...
//            boolean mappingExists = userCohortMappingRepository.existsByUserUserIdAndCohortCohortId(
...
//                logger.info("User {} enrolled in cohort {}", user.getUserId(), defaultCohort.getCohortId());
//            } else {
//                logger.info("User {} is already enrolled in cohort {}", user.getUserId(), defaultCohort.getCohortId());
//            }
//        } else {
//            logger.warn("No default cohort found for program {}", program.getProgramId());
//        }
//    }
//    
//    /**
...
//        return cohortRepository.findByProgramIdAndActive(program.getProgramId(), true)
//            .stream()
//            .findFirst();
//    }
//    
...
//            content.append("Welcome to the Flow of English program: ").append(programName).append(".\n\n");
//            content.append("Your account has been created and you can now access our learning platform.\n\n");
//            content.append("Your login details:\n");
//            content.append("Username: ").append(user.getUserId()).append("\n");
//            content.append("Password: ").append(DEFAULT_PASSWORD).append(" (Please change after first login)\n\n");
//            content.append("Thank you for joining us!\n\n");
//            content.append("Best regards,\n");
//            content.append("The Flow of English Team");
//            
//            // Send email
//            emailService.sendSimpleMessage(user.getUserEmail(), subject, content.toString());
//            logger.info("Welcome email sent to user: {}", user.getUserEmail());
//        } catch (Exception e) {
//            logger.error("Failed to send welcome email to user {}: {}", user.getUserEmail(), e.getMessage());
//            // Don't throw exception here, as user creation should still succeed even if email fails
//        }
//    }
//}