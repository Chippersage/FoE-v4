...
public class PaymentEvent {
    ...
    public PaymentEvent(String eventType, String paymentId, String orderId, Double amount,
                       String status, String errorCode, String errorDescription, 
                       String rawPayload, Long subscriptionId) {
    ...
    public String toString() {
        return "PaymentEvent [id=" + id + ", eventType=" + eventType + ", paymentId=" + paymentId + ", orderId="
                ...
                + ", createdAt=" + createdAt + ", subscriptionId=" + subscriptionId + "]";
    }
}