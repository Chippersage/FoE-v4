  ...
  return (
    <aside className="bg-white text-black flex flex-col">
      ...
      <div className="hidden md:flex flex-col fixed top-0 left-0 h-screen w-72 border-r border-gray-300 z-20 bg-white">
        ...
        <div className="px-4 py-2 text-orange-500 font-semibold text-lg border-b border-gray-200">
        ...
        <div className="px-4 py-2 border-b border-gray-100 bg-gray-50">
          <div className="flex items-center gap-3 text-xs text-gray-600">
            ...
            <div className="flex items-center gap-1">
              <div className="w-3 h-3 rounded-full border-2 border-orange-500 bg-orange-500 flex items-center justify-center">
        ...
        <div className="flex-1 overflow-y-auto px-3 py-4 space-y-4">
          {stages.map((stage, stageIndex) => (
            <li
              key={stage.stageId}
              className="list-none border-b border-gray-200 pb-3"
            >
              <button
                onClick={() => toggleStage(stage.stageId)}
                className="flex flex-col w-full text-left text-gray-800 transition-colors hover:text-gray-900 cursor-pointer"
              >
                      ...
                      <li
                        ...
                        className={`flex items-center gap-3 cursor-pointer p-2 rounded transition-colors group ${
                          currentActiveId === unit.unitId
                            ...
                            : "hover:text-orange-500 hover:bg-orange-50 text-gray-700"
                        } ${!unit.unitLink ? "opacity-50 cursor-not-allowed" : ""}`}
                      >
                        <RoundCheckbox
                          completed={
                            unit.completionStatus?.toLowerCase() === "yes"
                          }
                          active={currentActiveId === unit.unitId}
                        />
                        <FileText
                          size={14}
                          className="flex-shrink-0 text-gray-600 group-hover:text-orange-500"
                        />
